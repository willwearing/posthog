...
class TestFeatureFlag(APIBaseTest, ClickhouseTestMixin):
    ...
    def test_local_evaluation_caching_basic(self):
        ...
        # Check that cache is now populated (using HyperCache format with token-based keys)
    ...
    def test_local_evaluation_caching_with_cohorts(self):
        ...
        # Check separate cache key for cohorts version (using HyperCache format with token-based keys)
    ...
    def test_local_evaluation_cache_invalidation_on_flag_change(self, mock_on_commit):
        ...
        # Verify cache is populated and get original content (using HyperCache format with token-based keys)
        cache_key = f"cache/team_tokens/{self.team.api_token}/feature_flags/flags_without_cohorts.json"
        cache_key_cohorts = f"cache/team_tokens/{self.team.api_token}/feature_flags/flags_with_cohorts.json"
